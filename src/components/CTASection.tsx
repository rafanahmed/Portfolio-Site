    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/Images/RafanAhmedResume_20250722_NOPHONENUM.pdf" className="bg-gray-100 p-12 flex flex-col items-start transition-transform hover:translate-y-[-4px]">
